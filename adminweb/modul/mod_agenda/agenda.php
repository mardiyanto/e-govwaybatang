...
switch($_GET[act]){
  ...
  case "tambahagenda":
    echo "<h2>Tambah Agenda</h2>
          ...
          <tr><td>Isi Agenda</td>  <td> <textarea name='isi_agenda' id='loko' style='width: 600px; height: 150px;'></textarea></td></tr>
  ...
  case "editagenda":
    ...
    echo "<h2>Edit Agenda</h2>
          ...
          <tr><td>Isi Agenda</td>  <td> <textarea name='isi_agenda' id='loko' style='width: 600px; height: 150px;'>$r[isi_agenda]</textarea></td></tr>
