...
switch($_GET[act]){
  ...
  default:
    ...
    echo "<h2>Profil $r[nama_website]</h2>
          ...
          <tr><td>Meta Deskripsi</td><td> : <input type=text name='meta_deskripsi' value='$r[meta_deskripsi]' size=90></td></tr>
          <tr><td>Meta Keyword</td><td> : <input type=text name='meta_keyword' value='$r[meta_keyword]' size=90></td></tr>
