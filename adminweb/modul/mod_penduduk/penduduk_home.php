...
<div class='row'>
 ...
 Data Kartu Keluarga (Penduduk)
		   ...
		   <div id=main-content> 
		       <div class='box-header'>
 <a href='?module=penduduk&act=tambah' class='btn btn-primary btn-sm'>
...
<div class='row'>
		  ...
		  <div style='width:50%; float:right'>
			  ...
			  <input type=text class='form-control' name='g' value='$row[kecamatan]' size=60 disabled>
			   </p> 

			   <p class=inline-small-label> 
			   <label for=field4>Kab/Kota</label>
			  <input type=text class='form-control' name='h' value='$row[kab_kota]' size=60 disabled>
			   </p>

			   <p class=inline-small-label> 
			   <label for=field4>Propinsi</label>
			  <input type=text class='form-control' name='i' value='$row[propinsi]' size=60 disabled>
			   </p>  
		  </div>
...
<div class='row'>
		  ...
		  <div style='width:50%; float:right'>
			  ...
			  <input type=text class='form-control' name='f' value='$row[desa_kelurahan]' size=60>
			   ...
			   <p class=inline-small-label> 
			   <label for=field4>Kecamatan</label>
			  <input type=text class='form-control' name='g' value='$row[kecamatan]' size=60>
			   </p> 

			   <p class=inline-small-label> 
			   <label for=field4>Kab/Kota</label>
			  <input type=text class='form-control' name='h' value='$row[kab_kota]' size=60>
			   </p>

			   <p class=inline-small-label> 
			   <label for=field4>Propinsi</label>
			  <input type=text class='form-control' name='i' value='$row[propinsi]' size=60>
			   </p>  
		  </div>
		  <div style='clear:both'></div>
			  ...
			  <tbody>
			  	  <tr>
			  	  	  ...
			  	  	  <td><input type=text class='form-control' name='bb' style='width:115px'></td>
			  	  	  <td><select class='form-control select2' name='cc' style='width:90px !important'>
			  	  	  		<option value='' selected>- Pilih -</option>
			  	  	  		<option value='laki-laki'>Laki-laki</option>
			  	  	  		<option value='perempuan'>Perempuan</option>
			  	  	  	  </select></td>
			  	  	  <td><input type=text class='form-control' name='dd' style='width:70px'></td>
			  	  	  <td><input type=text class='form-control' name='ee' style='width:70px'></td>
			  	  	  <td><input type=text class='form-control' name='ff' style='width:50px'></td>
			  ...
			  if ($_GET[idd]!=''){
			  	 ...
			  	 if ($e[jenis_kelamin]=='laki-laki'){ $select1 = 'selected'; }elseif ($e[jenis_kelamin]=='perempuan'){ $select2 = 'selected'; }
			  	  ...
			  	  echo "<tr>
			  	  	  ...
			  	  	  <td><input type=text class='form-control' name='bb' value='$e[nik]' style='width:115px'></td>
			  	  	  <td><select class='form-control select2' name='cc' style='width:90px !important'>
			  	  	  		<option value='' selected>- Pilih -</option>
			  	  	  		<option value='laki-laki' $select1>Laki-laki</option>
			  	  	  		<option value='perempuan' $select2>Perempuan</option>
			  	  	  	  </select></td>
			  	  	  <td><input type=text class='form-control' name='dd' value='$e[tempat_lahir]' style='width:70px'></td>
			  	  	  <td><input type=text class='form-control' name='ee' value='$e[tanggal_lahir]' style='width:70px'></td>
			  	  	  <td><input type=text class='form-control' name='ff' value='$e[agama]' style='width:50px'></td>
