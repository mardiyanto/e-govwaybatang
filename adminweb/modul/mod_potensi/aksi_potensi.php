...
if ($module=='potensi' AND $act=='hapus'){
  $data=mysql_fetch_array(mysql_query("SELECT gambar FROM potensi WHERE id_berita='$_GET[id]'"));
  if ($data['gambar']!=''){
     mysql_query("DELETE FROM potensi WHERE id_berita='$_GET[id]'");
...
elseif ($module=='potensi' AND $act=='input'){
  ...
  if (!empty($lokasi_file)){
    ...
    mysql_query("INSERT INTO potensi(judul,
                                    judul_seo,
                                    id_kategori,
                                    headline,
                                    username,
