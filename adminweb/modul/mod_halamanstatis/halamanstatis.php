...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Halaman Statis</h2>
          ...
          <table>
          <tr><th>no</th><th>judul</th><th>link statis</th><th>tgl. posting</th><th>aksi</th></tr>";
    ...
    while($r=mysql_fetch_array($tampil)){
      ...
      echo "<tr><td>$no</td>
                <td>$r[judul]</td>
                <td>statis-$r[id_halaman]-$gabung_huruf</td>
                <td>$tgl_posting</td>
  ...
  case "tambahhalamanstatis":
    echo "<h2>Tambah Halaman Statis</h2>
          ...
          <tr><td>Isi Halaman</td>  <td> <textarea name='isi_halaman' id='editor1' style='width: 600px; height: 350px;'></textarea><script>
  ...
  case "edithalamanstatis":
    ...
    echo "<h2>Edit Halaman Statis</h2>
          ...
          <tr><td>Isi Halaman</td>   <td> <textarea name='isi_halaman' id='editor1' style='width: 600px; height: 350px;'>$r[isi_halaman]</textarea><script>
