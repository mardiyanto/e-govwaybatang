...
switch($_GET[act]){
  ...
  default:
    ...
    $tampil = mysql_query("SELECT * FROM gallery  ORDER BY id_gallery DESC LIMIT $posisi,$batas");
  ...
  case "tambahgalerifoto":
    ...
    echo "</select></td></tr>
          <tr><td>Keterangan</td>  <td> <textarea id='editor1' name='keterangan' style='width: 600px; height: 150px;'></textarea>
		   <script>
  ...
  case "editgalerifoto":
    ...
    echo "</select></td></tr>
          <tr><td>Keterangan</td>   <td> <textarea id='editor1' name='keterangan' style='width: 600px; height: 150px;'>$r[keterangan]</textarea>
		   <script>
