...
<div class='row'>
   ...
   <div class='callout callout-info'>
            ...
            <p>Hai <b>$_SESSION[namalengkap]</b>, Silahkan klik menu pilihan yang berada di sebelah kiri untuk mengelola konten website anda <br/>atau pilih ikon-ikon pada  
  ...
  echo " WIB</p>
			 ...
			 <div class='col-lg-3 col-xs-6'>
              ...
              <div class='inner'>
                  <h3>Domisili</h3>
                  <p>Surat Domisili</p>
                </div>  <a href='media.php?module=domisili'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=domisili' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
	 ...
	 <div class='col-lg-3 col-xs-6'>
              ...
              <div class='inner'>
                  <h3>Surat</h3>
                  <p>Kelakuan Baik</p>
                </div>  <a href='media.php?module=kalakuanbaik'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=kalakuanbaik' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
	...
	<div class='col-lg-3 col-xs-6'>
              ...
              <div class='inner'>
                  <h3>Surat</h3>
                  <p>Kelakuan Kematian</p>
                </div>  <a href='media.php?module=k_mati'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=k_mati' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
			...
			<div class='col-lg-3 col-xs-6'>
              ...
              <div class='inner'>
                  <h3>Surat</h3>
                  <p>Tidak Mampu</p>
                </div>  <a href='media.php?module=ket_mampu'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=ket_mampu' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
              ...
              <div class='inner'>
                  <h3>Surat</h3>
                  <p>Belum Menikah</p>
                </div>  <a href='media.php?module=lajangu'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=lajang' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
              ...
              <div class='inner'>
                ...
                </div>  <a href='media.php?module=keteranganusaha'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=keteranganusaha' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
              ...
              <div class='inner'>
                  <h3>Surat</h3>
                  <p>Surat Kuasa</p>
                </div>  <a href='media.php?module=kuasa'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=kuasa' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
			...
			<div class='col-lg-3 col-xs-6'>
              ...
              <div class='inner'>
                  <h3>Surat</h3>
                  <p>Izin Keramaian</p>
                </div>  <a href='media.php?module=izinkeramaian'>
                <div class='icon'>
                  <i class='fa fa-envelope-o'></i>
                </div></a>
                <a href='media.php?module=izinkeramaian' class='small-box-footer'>More info <i class='fa fa-arrow-circle-right'></i></a>
              </div>
            </div>
...
elseif($_GET['module']=='domisili'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_domisili/domisili.php";
}
}
//cetak sura domisili
elseif($_GET['module']=='cetak'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/cetak.php";
  }  
}
elseif($_GET['module']=='lajang'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_lajang/lajang.php";
  }  
}

elseif($_GET['module']=='ket_mampu'){
    if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_k_mampu/ket_mampu.php";
}
}

elseif($_GET['module']=='k_mati'){
  if ($_SESSION['leveluser']=='admin'){
    include"modul/mod_surat/mod_k_mati/k_mati.php";
  }
  
}

elseif($_GET['module']=='izinkeramaian'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_izinkeramaian/lajang.php";
  }  
}

elseif($_GET['module']=='kalakuanbaik'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_kelakuanbaik/lajang.php";
  }  
}

elseif($_GET['module']=='keteranganusaha'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_keteranganusaha/lajang.php";
  }  
}

elseif($_GET['module']=='kuasa'){
  if ($_SESSION['leveluser']=='admin'){
  include"modul/mod_surat/mod_kuasa/lajang.php";
  }  
}

elseif($_GET['module']=='kadis'){
  if($_SESSION['leveluser']=='admin'){
    include"modul/mod_kades/kades.php";
  }
  
}  
elseif($_GET['module']=='buatsurat'){
  if($_SESSION['leveluser']=='admin'){
    include"modul/mod_buatsurat/surat.php";
  }
  ...
  <div style='background:#e0e0e0; padding:5px; margin-bottom:16px;'
    ...
    Terimakasih</p>
	 ...
	 <form method='post' action='proses_domisili.html' onclick='' style='margin-left:46px;' class='AdvancedForm' class='basic-grey' >
	  ...
	  <tr><td>Nama Lengkap</td>	 <td>  <input type='text' class='form-control' name='nama'  value='$hasil[nama_lengkap]'  id='nama' size=40></td></tr>
	  <tr><td>Tempat Tgl Lahir</td>	 <td> <input type='text' class='form-control' name='ttl'  value='$hasil[tempat_lahir],$hasil[tanggal_lahir]'  id='kosong' size=40></br>
...
echo"PEREMPUAN";
				...
				'  id='jk' size=20></td></tr>
	  <tr><td>Alamat Lengkap</td>	<td> <input type='text' class='form-control' name='alamat' value='$hasil[alamat], RT/RW $hasil[rt_rw]'  size=30></td></tr>
	  <tr><td>Agama</td>		<td> :	 
	 ...
	 <tr><td>No Hp Aktif</td>	  	<td> <input type='text' class='form-control' name='hp' size=10></td></tr></br>
	  ...
	  (* silahkan isi keterangan kegunaan surat
	   ...
	   <tr><td>Karangsari</td>	  	<td> <input type='text' class='form-control' name='waktu' value='$hari_ini, $tgl_skrg-$bulan-$thn_sekarang'  size=30></td></tr></br>
...
$cek= mysql_query ($sisipkan);
    ...
    if ($cek) {
  echo "<script>alert(' terima kasih data surat permohonan anda sudah terkirim,silahkan menunggu pemanggilan atau menemui staf administasi di balaipekon atau lihat status surat'); window.location = 'media.php?module=home'</script>";
}
else{
...
<form name='form1' id='form_combo' role='form'  method='post' action='proses_surat_kurang_mampu.html'>
                                                    ...
                                                    <input  name='nama'  value='$hasil[nama_lengkap]'  id='nama' type='text' class='form-control' aria-required='true'>
                                                    ...
                                                    <input name='ttl'  value='$hasil[tempat_lahir],$hasil[tanggal_lahir] '  type='text' class='form-control' aria-required='true'>
...
echo"PEREMPUAN";
				...
				'  id='jk' type='text' class='form-control' aria-required='true'>
                                               ...
                                               <textarea style='width: 100%;' id='comment' name='alamat' cols='45' rows='6' aria-required='true'>$hasil[tempat_lahir],$hasil[tanggal_lahir] </textarea>
...
<div class='row'>
 ...
 <form method='post' action='proses_surat_keterangan_kematian.html' onclick='' style='margin-left:66px;' class='AdvancedForm'>
	  ...
	  <tr><td>NIK</td>	<td>  <input type='text' class='form-control' name='nik'  size=20 id='nama'></td></tr>
	...
	<tr><td></td>
	 <tr><td>Hari/Tanggal</td>	<td>  <input type='text' class='form-control' name='hari' size=40></td></tr>
	  ...
	  <input type='hidden' class='form-control' name='waktu' value='$hari_ini, $tgl_skrg-$bulan-$thn_sekarang'  size=30>
				...
				'  id='jk' type='text' class='form-control' aria-required='true'>
						...
						<option value='Janda/Duda'>Janda/Duda</option>
                                               ...
                                               <textarea style='width: 100%;' id='comment' name='ket' cols='45' rows='6' aria-required='true'></textarea>
                                                    ...
                                                    <input id='email' name='waktu' value='$hari_ini, $tgl_skrg-$bulan-$thn_sekarang'  type='text' class='form-control' aria-required='true'>
                                                </p>
                                                <p class='form-submit'>
                                                    <input name='submit' class='btn btn-primary btn-sm' type='submit' id='submit' value='Buat Surat'>
                                                </p>
...
<table class='table table-bordered table-striped'>
     <form method='post' action='proses_k_nikah.aspx' onclick='' style='margin-left:12px;' onSubmit='return validasi_domisili(this)'>
	  ...
	  <tr><td>Nama Lengkap</td>	<td>  <input type='text' class='form-control' name='nama'  value='$hasil[nama_lengkap]'  id='nama' size=40></td></tr>
	  <tr><td>Tempat Tgl Lahir</td>	<td> <input type='text' class='form-control' name='ttl'  value='$hasil[tempat_lahir],$hasil[tanggal_lahir] '  size=40></td></tr>
	  <tr><td>Jenis Kelamin</td>	<td> <input type='text' class='form-control' name='jk' value='"; if($hasil[jenis_kelamin]=='PEREMPUAN'){
...
<tr><td>No Hp Aktif</td>	  	<td> <input type='text' class='form-control' name='hp' size=10></td></tr></br>
   ...
   <table class='table table-bordered table-striped'>
	  ...
	  <tr><td>Jenis Kelamin</td>	<td> 	<select class='form-control select2' name='jk_kuasa' id='status' >
						<option value='LAKI-LAKI'>LAKI-LAKI</option>
						<option value='PEREMPUAN'>PEREMPUAN</option>
...
elseif($_GET['module']=='statussurat'){
	$sql=mysql_query("SELECT * FROM data_penduduk_detail,status_surat WHERE data_penduduk_detail.nik=status_surat.nik");
  echo" <section class='content'>
<div class='row'>
<div class='col-lg-12'>
...
echo "
  ...
  <td width=80>  
  <a href=media.php?module=proseshapus&id_status=$r[id_status]>
hapus</a> 
...
// Modul hapus
elseif ($_GET['module']=='proseshapus'){
   mysql_query("DELETE FROM status_surat WHERE id_status='$_GET[id_status]'");
  
echo "<script>window.alert('Data Anda Bershasil di simpan, Silahakan Melanjutkan Ke menu berikutnya');
        window.location=('media.php?module=statussurat')</script>";

} 
 //status surat
elseif($_GET['module']=='logpenduduk'){
	$sql=mysql_query("SELECT * FROM login_penduduk,data_penduduk_detail WHERE data_penduduk_detail.nik=login_penduduk.nik ORDER BY id DESC");
  echo"<section class='content'>
<div class='row'>
<div class='col-lg-12'>
...
echo "
  ...
  <td>$r[nik]</td>
  <td width=80>$r[nama_lengkap]</td>
  <td width=50>$r[tgl]</td>
  <td width=50>$r[jam]</td>
  <td width=80>
   
  <a href=media.php?module=proseshapuslog&id=$r[id] title='Edit' class='with-tip'>
  <center>hapus</a>
...
// Modul log
elseif ($_GET['module']=='proseshapuslog'){
   mysql_query("DELETE FROM login_penduduk WHERE id='$_GET[id]'");
  
echo "<script>window.alert('Data Anda Bershasil di simpan, Silahakan Melanjutkan Ke menu berikutnya');
        window.location=('media.php?module=logpenduduk')</script>";
...
// Bagian Kategori potensi
elseif ($_GET['module']=='katpo'){
  if ($_SESSION['leveluser']=='admin'){
    include "modul/mod_kategoripotensi/kategori.php";
  }
}

// Bagian Berita potensi
