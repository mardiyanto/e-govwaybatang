...
$con=mysql_query("SELECT * FROM srt_k_baik WHERE id_srt_d='$id_srt_d'");
$hasil=mysql_fetch_array($con);
$isi=1;
mysql_query("UPDATE srt_k_baik SET ket_ctk='$isi' WHERE id_srt_d='$id_srt_d'");
...
<table width="900" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td colspan="5"><div align="center" class="style6">PEKON KARANGSARI</div></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="42">&nbsp;</td>
    <td colspan="6"><p align="center" class="style4"><strong>SURAT KETERANGAN KELAKUAN BAIK</strong></p>
    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td colspan="6"><div align="center" class="style7">Nomer :  <strong>470</strong>/ <?php echo"$hasil[id_srt_d]";?> /<strong>C.04.2007/
...
<?php $thn=date("Y"); echo"$thn";?></strong>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6"><span class="style8"> Kepala Pekon Karangsari Kecamatan Pagelaran Kabupaten Pringsewu menerangkan bahwa : </span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6" valign="top"><p align="justify" class="style8">Orang Tersebut di atas, adalah benar-bener warga kami dan berkelakuan baik di mayarakat. Surat keterangan ini di buat untuk keperluan <strong> ' <?php echo"$hasil[ket]";?> ' </strong></p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><p class="style8"> Karangsari  , <?php echo  $tanggal ." ". $bulan ." ". $tahun; ?></p>
      <p class="style8">Kepala Pekon Karangsari </p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td colspan="2"><span class="style8"><strong>(<?php echo"$k[nama]";?>) </strong></span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
