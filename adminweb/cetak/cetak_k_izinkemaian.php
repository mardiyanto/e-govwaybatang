...
<table width="900" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    ...
    <td colspan="6" class="style4">
      <div align="right">Karangsari,<?php echo  $tanggal ." ". $bulan ." ". $tahun; ?></div>
  </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<?php $thn=date("Y"); echo"$thn";?></strong></td>
    ...
    <td width="6">&nbsp;</td>
    <td width="386">&nbsp;</td>
    <td width="164">Kapolsek Pagelaran </td>
    <td width="89">&nbsp;</td>
  </tr>
    <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6"><span class="style9">Yang bertanda tangan dibawah ini Kepala Pekon Karangsari Kecamatan Pagelaran Kabupaten Pringsewu dengan ini menerangkan bahwa  :</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
