...
<table width="900" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6"><span class="style9">Kepala Pekon Karangsari Kecamatan Pagelaran Kabupaten Pringsewu menerangkan bahwa :</span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6" valign="top"><p align="justify" class="style4">Orang tersebut diatas adalah benar penduduk <span class="style9">Pekon Karangsari Kecamatan Pagelaran Kabupaten Pringsewu</span>, dan orang tersebut benar telah meninggal dunia pada : </p>    </td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td><span class="style4"></span></td>
