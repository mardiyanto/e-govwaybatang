...
<table width="900" border="0" align="center" bgcolor="#FFFFFF">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6" class="style4"><span class="style8">Yang bertanda tangan dibawah ini Kepala Pekon Gedong Tataan Kecamatan Gedong Tataan Kabupaten Pesawaran menerangkan dengan sebenarnyabahwa: </span></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td class="style4">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="6" valign="top" class="style4"><p align="justify" class="style4"> Orang tersebut diatas adalah benar-benar penduduk Pekon Gedong Tataan Kecamatan Gedong Tataan Kabupaten Pesawaran dan terdaftar pada Pekon Gedong Tataan Kecamatan Gedong Tataan Kabupaten Pesawaran sejak tahun <?php echo"$hasil[tahun]";?>.</p></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
